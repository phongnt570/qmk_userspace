...
## Regenerate the printable layout

`layout.pdf` is generated by the tracked [`generate_layout.py`](generate_layout.py), not edited manually. From the userspace repository root, run:
